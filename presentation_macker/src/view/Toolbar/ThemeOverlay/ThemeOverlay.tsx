...
import { selectCurrentSlide } from "@/store/selectors/slideSelectors";
...
const ThemeOverlay: React.FC<{ onClose: () => void }> = ({ onClose }) => {
    ...
    const onSave = () => {
        ...
        dispatch(changeSlideBackground({ slideId: currentSlide!.id, background: theme }));
            ...
            <div className={styles.overlayContent}>
                ...
                <div className={styles.properties}>
                    ...
                    {image ? (
                        <>
                            <div
                                className={`${styles.property} ${styles.start}`}
                            >
